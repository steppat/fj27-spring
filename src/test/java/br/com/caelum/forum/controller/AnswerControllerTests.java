...
public class AnswerControllerTests {
    ...
    public void shouldProcessSuccessfullyNewAnswerRequest() throws Exception {
        ...
        RegisterNewAnswerInputDto inputDto = new RegisterNewAnswerInputDto("Não consigo subir servidor");
    ...
    public void shouldRejectNewAnswerRequest() throws Exception {
        ...
        RegisterNewAnswerInputDto inputDto = new RegisterNewAnswerInputDto("bad");
